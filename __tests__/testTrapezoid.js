...
describe('We check similarity with overlap of trapezoid', function () {
  ...
  it('getSimilarity', function () {
    comparator9.getSimilarity([[1, 2], [1, 1]], [[1, 1]]).similarity.should.equal(0.8333333333333333);
    comparator9.getSimilarity([[1, 1]], [[1, 2], [1, 1]]).similarity.should.equal(0.8333333333333333);
    comparator9.getSimilarity([[1, 1]], [[4, 1]]).similarity.should.equal(0.08333333333333337);
    comparator9.getSimilarity([[1, 1]], [[1, 4], [1, 1]]).similarity.should.equal(0.5416666666666667);
